...
const projects = [
  {
    ...
    description: [
      ...
      'Over a focused 2-3 month period, the migration achieved an 8.5x reduction in developer environment startup time. The improvement had an outsized impact given the scale—hundreds of Confluence frontend developers now spend significantly less time waiting and more time building.',
    ],
